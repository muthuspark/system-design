...
OAuth (Open Authorization) is a widely used authorization framework that allows third-party applications to access user data hosted by a service provider without requiring the user to share their credentials.  This blog post will look at the intricacies of OAuth implementation, focusing on the different grant types and providing practical examples.
